  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between bg-gray-800 rounded-lg p-4"
      >
          ...
          {searchable && (
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-64 bg-gray-700 border border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
              />
            </div>
          )}
